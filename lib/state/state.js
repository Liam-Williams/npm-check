...
function state(userOptions) {
    ...
    function staticOutputFunc() {
        staticOutput(currentState);
    }

    function interactiveUpdateFunc() {
        interactiveUpdate(currentState);
    }

    currentState.staticOutput = staticOutputFunc;
    currentState.interactiveUpdate = interactiveUpdateFunc;
